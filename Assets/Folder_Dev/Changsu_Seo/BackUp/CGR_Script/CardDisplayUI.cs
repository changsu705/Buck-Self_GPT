...
/// - IsOpen 프로퍼티를 제공하여, 패널이 열려있는 동안 다른 입력을 막도록(예: 총 발사) 도와줍니다.
/// </summary>
public class CardDisplayUI : MonoBehaviour
{
    ...
    /// (RevolverTurnPossession이 카드 클릭 시 이 함수를 호출합니다.)
    /// </summary>
    ...
    /// <summary>
    /// 패널을 켜고 (1), 설정된 시간만큼 대기 후 (2), 자동으로 닫는 (3) 코루틴입니다.
    /// </summary>
    private IEnumerator Co_ShowAndHide()
    {
        ...
        // (yield return: 이 줄에서 코루틴의 실행을 잠시 '일시정지'했다가, 시간이 지나면 다음 줄부터 다시 시작)
